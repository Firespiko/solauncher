...
const MovableSticker: React.FC<StickerProps> = ({
  text,
  initialX,
  initialY,
  id,
  ...
  return (
    <div
      className={`absolute select-none cursor-move z-10 px-3 py-2 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 backdrop-blur-sm rounded-lg border border-cyan-400/30 text-cyan-300 font-mono text-sm transition-all duration-200 hover:scale-110 hover:shadow-lg hover:shadow-cyan-500/25 ${
        isDragging ? "scale-110 shadow-lg shadow-cyan-500/50" : ""
      }`}
      style={{
        left: `${position.x}px`,
        top: `${position.y}px`,
  ...
  return (
    <div className="min-h-screen bg-black overflow-hidden relative">
      ...
      <nav className="relative z-20 flex items-center justify-between px-8 py-6">
        ...
        <h1 className="text-2xl font-bold text-white italic">ngmi Launchpad</h1>
